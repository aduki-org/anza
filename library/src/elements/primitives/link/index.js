  ...
  methods: {
    _update() {
      ...
      if (external && !existingIcon) {
        ...
        const html = '<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6m11-3H14m8 0v8m0-8L10 14"/>';
        if (typeof svg.setHTMLUnsafe === "function") {
          svg.setHTMLUnsafe(html);
        } else {
          svg.innerHTML = html;
        }
        a.appendChild(svg);
